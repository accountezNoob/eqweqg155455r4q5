...
function DiscordLib:Window(text)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			ChannelBtnTitle.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.TextColor3 = Color3.fromRGB(255, 45, 45)
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(210,60,60)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function ChannelContent:Seperator()
				...
				Seperator2.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownFrameMainOutline.BackgroundColor3 = Color3.fromRGB(14, 15, 17)
			...
			function ChannelContent:Textbox(text, placetext, disapper, callback)
				...
				TextboxFrameOutline.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
				...
				TextBox.Focused:Connect(function()
					TweenService:Create(
						TextboxFrameOutline,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(228, 44, 44)}
					):Play()
				end)
